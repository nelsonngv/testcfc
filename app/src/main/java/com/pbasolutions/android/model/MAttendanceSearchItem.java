...
//    public static final String ISNOSHOW_COL = "ISNOSHOW";
    ...
    public String getComments(){ return Comments == null ? "" : Comments.replace("\\n", " ");}
    ...
    public void setHR_Shift_ID(int id) {
        HR_Shift_ID = id;
    }

    public String getHR_Shift_Name() {
        return HR_Shift_Name;
    }

    public void setHR_Shift_Name(String name) {
        HR_Shift_Name = name;
    }
}
